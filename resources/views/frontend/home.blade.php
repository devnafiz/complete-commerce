...
<link rel="stylesheet" type="text/css" href="{{secure_asset('frontend/plugins/slick-1.8.0/slick.css')}}">
<link rel="stylesheet" type="text/css" href="{{secure_asset('frontend/styles/main_styles.css')}}">
<link rel="stylesheet" type="text/css" href="{{secure_asset('frontend/styles/responsive.css')}}">
...
<div class="super_container">
	...
	@php
      ...
      //dd($feature);
      $special_offer=DB::table('products')->where('status','1')->where('special_offer','1')->orderBy('id','desc')->limit(8)->get();

      $hot =DB::table('products')
            ->join('brands','products.brand_id','brands.id')
            ->select('products.*','brands.brand_name_en')
						...
						<div class="deals_slider_container">
							...
							<div class="owl-carousel owl-theme deals_slider">
								...
								<div class="owl-item deals_item">
									<div class="deals_image"><img src="{{asset($ht->product_thambnail)}}" alt=""></div>
...
<script src="{{secure_asset('frontend/plugins/slick-1.8.0/slick.js')}}"></script>
