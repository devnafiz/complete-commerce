						...
						<div class="cruise-listing-form">
							<form class="text-center" action="{{route('coupon.store')}}" method="POST" enctype="multipart/form-data">
								...
								<div class="form-row">
									<div class="col-md">
										<div class="form-group">
											<label for="inputGroupSelect00" class="">Coupon Name:</label>
											<input type="text" class="form-control" required id="inputGroupSelect00" name="coupon">
										</div><!-- end form-group -->
									</div><!-- end column -->
								...
								<div class="form-row">
									<div class="col-md">
										<div class="form-group">
											<label for="inputGroupSelect00" class="">Discount:</label>
											<input type="text" class="form-control" required id="inputGroupSelect00" name="discount" >
										</div><!-- end form-group -->
									</div><!-- end column -->
