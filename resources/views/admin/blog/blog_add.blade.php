							...
							<form class="text-center" action="{{route('post.store')}}" method="POST" enctype="multipart/form-data">
								...
								<div class="form-row">
									<div class="col-md">
										<div class="form-group">
											<label for="inputGroupSelect00" class="">Title English:</label>
											<input type="text" class="form-control" required id="inputGroupSelect00" name="post_title_en">
										</div><!-- end form-group -->
									</div><!-- end column -->
								...
								<div class="form-row">
									<div class="col-md">
										<div class="form-group">
											...
											<input type="text" class="form-control" required id="inputGroupSelect00" name="post_title_hin" >
										</div><!-- end form-group -->
									</div><!-- end column -->
								...
								<div class="form-row">
									<div class="col-md">
										<div class="form-group">
											...
											<textarea cols="30" rows="4" name="post_details_en">
												Blog detai English
											</textarea>
										</div><!-- end form-group -->
									</div><!-- end column -->
								...
								<div class="form-row">
									<div class="col-md">
										<div class="form-group">
											...
											<textarea cols="30" rows="4" name="post_details_hin">
												Blog detai Hindi
											</textarea>
										</div><!-- end form-group -->
									</div><!-- end column -->
								...
								<div class="form-row">
									<div class="col-md">
										<div class="form-group">
											<label for="inputGroupSelect00" class="">Image:</label>
											<input type="file" class="form-control" required id="inputGroupSelect00" name="post_image" >
										</div><!-- end form-group -->
									</div><!-- end column -->
