								...
								<div class="form-row">
									<div class="col-md">
										<div class="form-group">
											...
											<input type="text" class="form-control" required id="inputGroupSelect00" name="category_name_en">
										</div><!-- end form-group -->
									</div><!-- end column -->
								...
								<div class="form-row">
									<div class="col-md">
										<div class="form-group">
											...
											<input type="text" class="form-control" required id="inputGroupSelect00" name="category_name_hin" >
										</div><!-- end form-group -->
									</div><!-- end column -->
