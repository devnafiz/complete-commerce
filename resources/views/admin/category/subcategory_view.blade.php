...
<div class="in-content-wrapper">
					...
					<div class="row no-gutters">
							<div class="col text-left">
								<div class="add-new">
									<a href="{{route('add.subcategory')}}">Add SubCategory<i class="fas fa-plus"></i></a>
								</div><!-- End add-new-->
							</div><!-- End column-->
							...
							<table id="example" class="display table-hover table-responsive-xl listing">
									...
									<tbody>
										...
										<tr>
											...
											<td><a href="#">{{$val->category_id}}</a></td>
											<td><a href="#">{{$val->subcategory_name_en}}</a></td>
											<td><a href="#">{{$val->subcategory_name_hin }}</a></td>
