				...
				<ul class="ml-auto list-unstyled nav-list list-inline d-flex my-auto">
					...
					<li class="nav-item list-inline-item dropdown profile">
						<a class="nav-link" href="#" id="navbarDropdown" role="button" data-toggle="dropdown"
							...
							<img src="{{asset('backend/images/commenter-1.jpg')}}" alt="" class="img-fluid rounded-circle" width="30px" />
						</a>
						...
						<div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdown">
							...
							<a href="{{route('admin.logout')}}" class="btn d-block text-left"><i class="fas fa-power-off"></i>Logout</a>
						</div>
					</li>
				</ul>
			</nav>
